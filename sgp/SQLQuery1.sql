...
ALTER TABLE [dbo].[TBL_GESTION_1]  NOCHECK CONSTRAINT FK_CAMP_GEST
ALTER TABLE [TBL_GESTION_1]   DROP CONSTRAINT FK_CAMP_GEST

TRUNCATE TABLE [TB_CAMPANIA]
ALTER TABLE [dbo].[TBL_GESTION_1]  WITH CHECK ADD constraint FK_CAMP_GEST FOREIGN KEY([in_campania]) REFERENCES [dbo].[TB_CAMPANIA] ([in_CampaniaID])
