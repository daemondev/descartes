<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="Frm_mensaje.aspx.cs" Inherits="Frm_mensaje" %>

<asp:Content ID="Content3" ContentPlaceHolderID="CONTENEDOR" Runat="Server">
    <script src="Libreria/js/Codigo_Web/mensaje.js"></script>
    ...
    <div style="text-align:center;">
        <table id="tb_conectados" class="mGrid" style="width:70%;margin-left:200px">  
            <thead>
                <tr>	    
                    <th style="text-align:center;">ADMINISTRADORES</th>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content" style="width: 650px;">
                ...
                <div class="modal-footer">
                    <table>
                        <tr>
                            <td><textarea id="enviarMensaje"rows="4" cols="77"></textarea></td>
