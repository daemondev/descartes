...
<div style=" overflow-y: scroll;height:445px;width:1100px; margin-left:18px;">			
	...
	<!--REGISTRO DE LOS DATOS DE DESCARTE-->
	<div id="plazo"  role="dialog" style="width:800px;height:500px;"  > 
				...
				<tr>
					...
					<td>
                        ...
                        <div style="background-color: black;" class="div_colores" > 
                            <input type="radio" id="chk_am" name="1" /><label style="color:yellow">Amarrillo</label>
                            <input type="radio" id="chk_ve" name="1"/><label style="color:green">Verde</label>
                            <input type="radio" id="chk_ro" name="1"/><label style="color:red">Rojo</label>                      
                        </div>
